...
기획자가 **기획부터 개발까지 혼자** 진행하고 있는 프로젝트입니다.
제품 정의(PRD)와 의사결정 기록부터 Streamlit 구현, 저장소 관리까지 전 과정을 직접 하고 있습니다.
**코딩은 바이브 코딩으로 진행합니다.**
그 과정에서 막힌 지점과 판단 근거를 [`docs/`](docs/)와 [`journal/`](journal/)에 남기고 있습니다.

- 왜 이렇게 만들었는지 → [의사결정 기록](docs/00-decisions.md)
- 무엇에 막히고 어떻게 풀었는지 → [개발 일지](journal/)
...
`MyDay 실행.command` 를 더블클릭하면 앱이 열립니다.
처음 한 번은 준비 작업(가상환경 + 라이브러리 설치)을 자동으로 하느라 1~2분 걸립니다.

> 매일 쓰려면 이 파일을 독(Dock)에 올려두세요. 앱처럼 쓸 수 있습니다.
> 끄려면 같이 열린 터미널 창에서 `Control + C` 를 누르거나 창을 닫으면 됩니다.
...
├── MyDay 실행.command # macOS 더블클릭 실행 파일
...
- [2026-06-19](journal/2026-06-19.md) — Git/GitHub 첫 시작
- [2026-06-22](journal/2026-06-22.md) — MyDay 프로젝트 착수
- [2026-08-20](journal/2026-08-20.md) — 저장소 정리와 통합

별도로 정리한 학습 노트: [Git 기초 정리](notes/git-cheatsheet.md)
